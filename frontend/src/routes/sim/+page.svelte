  ...
  <div>
    <div class="text-center">
      <div class="flex justify-center space-x-4 py-5">
        ...
        <div
          class="mb-4 text-center justify-center bg-red-500 text-white rounded-lg p-4 text-3xl square"
        >
          <p class="py-2">CPU</p>
          <button
      ...
      <div class="flex justify-center space-x-4 py-5">
        <div
          class="flex-none bg-green-500 text-white rounded-lg p-4 text-xl box px-5"
        >
        ...
        <div
          class="flex-none bg-blue-500 text-white rounded-lg p-4 text-xl box px-5"
        >
        ...
        <div
          class="flex-none bg-yellow-500 text-white rounded-lg p-4 text-xl box px-5"
        >
      ...
      <div class="mt-4 bg-purple-500 text-white rounded-lg p-4 text-4xl py-2">
        RAM
      </div>
    </div>
  </div>
